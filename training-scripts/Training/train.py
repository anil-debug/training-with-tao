...
class TAOTrainingFlow:
    ...
    """
    def __init__(self, tao_with_meta_path, cli_name="ngccli_cat_linux.zip", pretrained_model="fan_base_hybrid_nvimagenet", epochs="098"):
    ...
    def setup_environment(self):
        ...
        os.environ["HOST_SPECS_DIR"] = os.path.join(os.environ["LOCAL_PROJECT_DIR"], "dino", "specs")
...
if __name__ == "__main__":
    ...
    tao_training_flow = TAOTrainingFlow(tao_with_meta_path, cli_name, pretrained_model, epochs)
